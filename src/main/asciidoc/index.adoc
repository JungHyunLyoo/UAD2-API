...
==== Response paging link
include::{snippets}/attendance/getAllAttendanceList/links.adoc[]
...
==== Response paging link
include::{snippets}/attendance/createAttendanceNotUpdateMatching/links.adoc[]
...
==== Response paging link
include::{snippets}/attendance/createAttendanceUpdateMatching/links.adoc[]
